...
?>
    ...
    <section class="<?php echo esc_attr( $sec_class ) ?>" style="<?php echo $is_category_page ? 'margin-top: 0 !important;' : ''; ?>">
		<?php
    ...
    text-align: center;margin-top:30px;">Welcome to the HubSpot Developer Documentation. Build custom CRM and data-driven website experiences on HubSpot. Follow the steps below to get started, or jump directly into a quickstart that fits your build.</p>
        ...
        <div class="container">
            <div class="row <?php echo esc_attr( $is_row ) ?>">
				...
				if ( $blog_layout == 'list' ) {
					...
					<div class="mb-4 category-left-sidebar-col" style="border-right: 1px solid #e5e7eb;flex: 0 0 20% !important;max-width: 20% !important;position: sticky;top: 110px;">
				<style>
		...
		.category-right-sidebar-col {
			...
			overflow-y: auto;
			margin-top: 0px; /* Align with left sidebar and main content */
		}	
