...
function docy_scripts() {
	...
	wp_enqueue_style( 'docy-main', DOCY_DIR_CSS . '/style-main.css', array(), DOCY_VERSION . '.4' );
	...
	wp_enqueue_style( 'typography-schema', DOCY_DIR_CSS . '/typography-schema.css', array(), DOCY_VERSION . '.3' );
